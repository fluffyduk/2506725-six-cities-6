...
export const configRestSchema = convict<RestSchema>({
  ...
  DB_HOST: {
    doc: 'IP-адресс базы данных',
    format: 'ipaddress',
    env: 'DB_HOST',
    default: '127.0.0.1'
  },
  SALT: {
    doc: 'Соль для хэширования',
    format: String,
    env: 'SALT',
    default: null
  },
  ...
  UPLOAD_DIRECTORY: {
    doc: 'Директория для загрузки статичных файлов',
    format: String,
    env: 'UPLOAD_DIRECTORY',
    default: null,
  },
  JWT_SECRET: {
    doc: 'Секрет для JWT-аутентификации',
    format: String,
    env: 'JWT_SECRET',
    default: null
  },
  ...
  STATIC_DIRECTORY_PATH: {
    doc: 'Путь до папки со статичными ресурсами',
    format: String,
